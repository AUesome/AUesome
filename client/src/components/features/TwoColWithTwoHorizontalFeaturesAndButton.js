...
import TeamIllustrationSrc from "images/kit.jpg";
...
export default ({
  ...
  heading = (
    <>
      Therapy <span tw="text-primary-500">Kits.</span>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      title: "Accessible",
      description:
        "We price our kits at only $15 – if you have any financial concerns, please contact us.",
    ...
    },
    {
      ...
      title: "Delivered",
      description:
        "We deliver your kit at to your doorstep after you order, international fees may apply.",
