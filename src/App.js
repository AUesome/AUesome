...
import blog14 from "posts/14.js";
import blog15 from "posts/15.js";
  ...
  return (
    <Router>
      <Switch>
        ...
        />
        <Route
          path="/the-effectiveness-of-expressive-music-therapy"
          component={blog14}
          exact
        />
        <Route
          path="/the-benefits-of-floortime-play-therapy"
          component={blog15}
          exact
        />
        {/* redirects */}
