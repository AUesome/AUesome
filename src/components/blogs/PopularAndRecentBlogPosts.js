...
export default () => {
  ...
  const popularPosts = [
    {
      postImageSrc: Exercise,
      title: "The Benefits of Exercise for Children with Autism",
      description:
        "Engaging in physical activity such as sports has shown to be beneficial in many aspects, especially for children on the autism spectrum.",
      authorName: "by Saisri Tangirala",
      authorProfile: "edited by Anshul Gupta",
      url: "/blog",
      featured: true,
    },
    {
