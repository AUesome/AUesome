...
export default ({
  text = "Sign up to receive monthly resources and opportunities!",
  primaryLinkText = "Sign Up",
  primaryLinkUrl = "https://docs.google.com/forms/d/e/1FAIpQLSeTuVnWaGl2MJXEgeM2AsB3mSU9oPEVWGXymL4_joRiTr2vhg/viewform?usp=sf_link",
  secondaryLinkText = "Learn More",
  secondaryLinkUrl = "https://docs.google.com/document/d/1uZLggJMVMD-DtF8xps0URZrpsLuYX3O34nRmTE8xnAY/edit?usp=sharing",
  pushDownFooter = true,
}) => {
  return (
    <Container css={pushDownFooter && tw`mb-16`}>
      <ContentWithPaddingXl>
        <PrimaryBackgroundContainer>
          <Row>
            ...
            <LinksContainer>
              <PrimaryLink target={"_blank"} href={primaryLinkUrl}>
                {primaryLinkText}
              </PrimaryLink>
              <SecondaryLink target={"_blank"} href={secondaryLinkUrl}>
                {secondaryLinkText}
              </SecondaryLink>
            </LinksContainer>
          </Row>
