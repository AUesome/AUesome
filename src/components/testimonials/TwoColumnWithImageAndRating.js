...
export default ({
  ...
  heading = "Access and Advocacy",
  description = "AUesome strives to make personalized, interactive training and therapy for individuals with special needs accessible to all.",
  textOnLeft = false,
  url = "/about",
  testimonials = [
    {
      ...
      <ContentWithPaddingXl>
        <Row>
          ...
          <TextColumn textOnLeft={textOnLeft}>
            ...
            <TestimonialSlider arrows={false} ref={setSliderRef} href={url}>
